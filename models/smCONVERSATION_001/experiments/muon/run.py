...
def main():
    ...
    school = read_school(REPOSITORY_ROOT / "archive" / "models" / "smLANGUAGE_en_SCH_001" / "data" / "curriculum.jsonl")
    ...
    base_path = REPOSITORY_ROOT / "archive" / "models" / "smLANGUAGE_en_SCH_001" / "checkpoints" / "grade_01" / "best.pt"
